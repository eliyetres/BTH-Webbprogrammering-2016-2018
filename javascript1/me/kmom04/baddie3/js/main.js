...
(function(){
	...
	11,10,10,10,10,10,10,10,17,17,17,10,10,10,10,10,10,10,10,11,
	11,10,10,10,10,10,10,17,17,17,17,17,10,10,10,10,10,10,10,11,
	11,10,10,10,16,10,10,10,17,17,17,10,10,10,10,10,10,10,10,11,
	11,10,10,12,10,10,10,10,10,10,10,10,10,10,10,10,10,16,10,11,
	11,10,10,10,10,10,10,10,10,10,10,10,10,10,11,11,11,11,11,11,
	11,10,10,10,10,10,10,10,10,10,10,10,10,12,10,10,10,10,10,11,
	11,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,11,
	11,10,10,10,10,10,10,16,10,10,10,10,10,10,10,10,10,10,10,11,
	11,10,10,10,10,10,10,10,10,10,10,10,10,10,10,11,11,11,11,11,
	11,10,10,10,11,11,11,13,11,10,10,10,10,12,10,11,10,10,10,11,
	11,10,10,10,11,10,10,10,11,10,10,10,10,10,10,11,10,10,10,11,
	11,10,16,10,11,10,10,10,11,10,10,10,10,10,10,13,10,14,10,11,
	11,10,10,10,11,12,10,10,11,10,10,10,10,10,10,11,10,10,10,11,
	11,11,11,11,11,11,11,11,11,11,11,11,11,11,11,11,11,11,11,11,
	...
	var drawGamePlan = function(gameArea) {
		...
		for (i = 0; i < gameArea.length; i=i+1) {
			// Create the tile
	...
	var isBaddieMovable = function(moveLeft, moveTop){
		...
		switch(tile) {
			...
			case 11:
				...
				break;
			case 16:
				// Tree, don't move baddie
				console.log("Baddie collided with a tree: %s", tile);
				break;
			case 17:
				// Water, don't move baddie
				console.log("Baddie can't cross the water: %s", tile);
				break;
			case 12:
			...
			case 14:
				// Tile was cheese, move it and then baddie
				nextPos = tilePos + moveLeft + (gridSize*moveTop);
					nextTile = gameArea[nextPos];
				console.log("The next tile is: " + nextTile);
					if(nextTile == 10 || nextTile == 13) {
					moveTile(tilePos, nextPos);
					// Allow  baddie to move to the current tile
					movable = true;
					console.log("Moved the cheese!");
				} else {
					// if not empty - don't do anything else
					console.log("Can't push cheese - next tile is not empty");
				}
				break;
...
// UNCOMMENT THIS FUNCTION TO BE ABLE TO CONTINUE
	var moveTile = function(current, next) {
		...
		document.getElementById("n" + current).className = "tile t10"; // current tile will be empty
	};
