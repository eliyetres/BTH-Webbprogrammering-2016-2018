(function(){
    ...
    * 13 - door (passible)
    */
   var gameArea = [11, 11, 11, 11, 11, 11, 11, 11, 11, 11,
   ...
   function jump() {
      ...
      if(isBaddieMovable(0, -1)) {
         moveBaddie(0, -1);
         window.setTimeout(moveBaddie, 100, 0, 1);
         console.log("Baddie jumped");
      }
   }

   //Turn baddie image right
   function turnRight() {
      if (baddie.className == "baddie-left" && baddie.className != "baddie"){
         baddie.className = "baddie-right";
      }
   }

   //Turn baddie image left
   function turnLeft() {
      if (baddie.className != "baddie-left"){
